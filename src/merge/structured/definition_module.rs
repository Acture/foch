...
#[cfg(test)]
use crate::game::eu4::content::OneSidedRemovalPolicy;
use crate::game::eu4::script::parser::{AstFile, AstStatement, AstValue};
use crate::merge::kernel::{ConflictResolution, StructuralConflict};

use crate::merge::model::SemanticPartitionId;

#[cfg(test)]
use super::merge_clausewitz_files;
#[cfg(test)]
use super::trivia::merge_trivia;
use super::trivia::{attach_trivia, detach_trivia, merge_trivia_n_way};
use super::{
	AstAdapterError, ClausewitzKernelFacts, merge_clausewitz_files_n_way,
...
mod tests {
	...
	fn emit(file: &crate::game::eu4::script::parser::AstFile) -> String {
		crate::game::eu4::script::emit::emit_clausewitz_statements(&file.statements)
			.expect("emit module")
	}
