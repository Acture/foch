...
Steam Workshop mod directories, used as ground truth for measuring `foch`'s
merge quality. Full context is intentional: `foch merge` can make
...
- `workshop/<steam_id>/` — the full local compatch or patched mod directory.
