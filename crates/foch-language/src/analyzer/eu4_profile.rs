use super::content_family::{
	ConflictPolicy, ContentFamilyCapabilities, ContentFamilyDescriptor, ContentFamilyExtractor,
	ContentFamilyPathMatcher, ContentFamilyScopePolicy, GameId, GameProfile, MergeKeySource,
	ModuleNameRule, ScriptFileKind,
};
...
static EU4_CONTENT_FAMILIES: &[ContentFamilyDescriptor] = &[
	...
	.merge_key(MergeKeySource::BlockKey)
	.build(),
	...
	ContentFamilyDescriptor::prefix("events/decisions", "events/decisions/")
		...
		.scope(scope(ScopeType::Country))
		.capabilities(semantic_complete_and_merge_ready())
		.merge_key(MergeKeySource::ContainerChild)
		.build(),
	ContentFamilyDescriptor::prefix("events", "events/")
		...
		.scope(scope(ScopeType::Unknown))
		.capabilities(semantic_complete_and_merge_ready())
		.merge_key(MergeKeySource::InnerField("id"))
		.build(),
	...
	ContentFamilyDescriptor::prefix("common/defines", "common/defines/")
		...
		.merge_key(MergeKeySource::DefinesPath)
