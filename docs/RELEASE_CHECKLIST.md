...
4. ☐ Have the maintainer run `scripts/merge-quality/acceptance.fish` and confirm
   the fixed 14-case product acceptance completes successfully. This wrapper is
